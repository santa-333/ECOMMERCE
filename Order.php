...
if(isset($_POST['sub'])){
  ...
  $personEmail=$_POST['mail'];
  $personAddress=$_POST['address'];
  $personCountry=$_POST['country'];
  $personState=$_POST['state'];
  $personZipcode=$_POST['zip'];
  $productQuantity=$qa2;
  $modeOfpayment=$_POST['paymentMethod'];
  $TotalPrice=$total;
  $insert="INSERT INTO  `orderstable` (orderid,user_id,Name,email,address,country,state,zipcode,quantity,modd,Total_price)
  VALUES ('$orderId','$uid','$personName','$personEmail','$personAddress','$personCountry','$personState','$personZipcode','$productQuantity','$modeOfpayment','$TotalPrice')";
  $mysql=mysqli_query($data,$insert);
if($mysql){
  echo "success";
    header("location:sampleorder.php");
}
}
// echo $uid;
?>
  ...
  <main>
    ...
    ?>
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation"    novalidate method="post" require>
          <div class="row g-3">
            <div class="col-sm-6">
          ...
          <input class="w-100 btn btn-primary btn-lg" type="submit" name="sub"   value="Place order">
        </form>
      </div>
    </div>
  </main>
